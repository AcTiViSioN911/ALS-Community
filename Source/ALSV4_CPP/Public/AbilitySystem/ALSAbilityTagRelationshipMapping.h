...
#include "ALSAbilityTagRelationshipMapping.generated.h"

/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct FALSAbilityTagRelationship
{
	GENERATED_BODY()
...
UCLASS()
class UALSAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FALSAbilityTagRelationship> AbilityTagRelationships;
